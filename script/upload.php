...
class ImageManager {
    ...
    /**
     * This function check if a file is present in $_FILES,
     * then validates that the file is an image that fits our defined constraints. (See Config.php)
     * If the file is found to be a valid image, it is moved to permanent storage and renamed
     * with a uniqe name.
     * @return boolean returns true if upload successful, false otherwise.
     */
    ...
    public function getLatestException() {
        return $this->error;
    }
